...
# URL сайту
    url = f"https://www.forebet.com/en/football-predictions/under-over-25-goals/{year:04d}-{month:02d}-{day:02d}"
    print(url)
    ...
    with open("under_over/page_source.html", "w", encoding="utf-8") as file:
